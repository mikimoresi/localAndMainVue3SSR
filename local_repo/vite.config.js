...
var confJson =  require('./src/static/localconfig.js');


const base = confJson.localConfig.prod ?  confJson.localConfig.pwaBasePath : '/'

var aliases = {
  "@": path.resolve(__dirname, 'src'),
  "@main": path.resolve(__dirname, '../main_repo/'),
  //"@vue-material": path.resolve(__dirname, '../vue-material/'),
